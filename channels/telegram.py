...
from TuringClaw.config.paths import get_media_dir
from TuringClaw.config.schema import Base
from TuringClaw.security.network import validate_url_target
from TuringClaw.utils.helpers import split_message
...
class TelegramChannel(BaseChannel):
    ...
    async def _on_start(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        await update.message.reply_text(
            f"👋 Hi {user.first_name}! I'm TuringClaw.\n\n"
