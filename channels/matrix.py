...
try:
    ...
    raise ImportError(
        "Matrix dependencies not installed. Run: pip install TuringClaw-ai[matrix]"
    ) from e
...
from TuringClaw.config.paths import get_data_dir, get_media_dir
from TuringClaw.config.schema import Base
from TuringClaw.utils.helpers import safe_filename
