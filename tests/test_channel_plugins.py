...
from TuringClaw.config.schema import ChannelsConfig
...
def test_discover_plugins_loads_entry_points():
    from TuringClaw.channels.registry import discover_plugins
...
async def test_manager_loads_plugin_from_dict_config():
    ...
    with patch(
        "TuringClaw.channels.registry.discover_all",
...
def test_builtin_channel_default_config():
    ...
    from TuringClaw.channels.telegram import TelegramChannel
