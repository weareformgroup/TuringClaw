...
from TuringClaw.agent.tools.mcp import MCPToolWrapper, connect_mcp_servers
from TuringClaw.agent.tools.registry import ToolRegistry
from TuringClaw.config.schema import MCPServerConfig
...
async def test_connect_mcp_servers_enabled_tools_warns_on_unknown_entries(
    ...
    monkeypatch.setattr("TuringClaw.agent.tools.mcp.logger.warning", _warning)
